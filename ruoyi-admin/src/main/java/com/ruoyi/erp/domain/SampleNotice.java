...
public class SampleNotice extends ErpBaseBillEntity {
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("roundNumber", getRoundNumber())
            .append("customerApproved", getCustomerApproved())
            .append("customerFeedback", getCustomerFeedback())
            .append("factoryConfirmed", getFactoryConfirmed())
            .append("factoryConfirmDate", getFactoryConfirmDate())
