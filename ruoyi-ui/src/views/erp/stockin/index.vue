<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="stockinList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="类型" align="center" prop="inType" width="100">
      ...
      <el-table-column label="入库简介" align="center" prop="inDescription" width="200" :show-overflow-tooltip="true" />
      ...
      <el-table-column label="关联采购单号" align="center" prop="purchaseSn" width="140" />
...
export default {
  ...
  methods: {
    ...
    handleConfirm(row) {
      this.$modal.confirm('是否确认入库单编号为"' + row.sn + '"的数据？').then(() => {
        row.confirmStatus = '1'
    ...
    handleExport() {
      this.download('erp/stockIn/export', {
        ...this.queryParams
      }, `stock_in_${new Date().getTime()}.xlsx`)
    }
  }
}
</script>
