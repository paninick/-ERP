<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['erp:stockOut:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['erp:stockOut:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="stockOutList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="销售订单id" align="center" prop="salesId" />
      <el-table-column label="出库日期" align="center" prop="stockOutDate" width="180">
      ...
      <el-table-column label="状态" align="center" prop="status">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.erp_stock_status" :value="scope.row.status"/>
        </template>
      </el-table-column>
    ...
    <el-dialog :title="title" :visible.sync="open" width="60%" append-to-body :close-on-click-modal="false" :close-on-press-escape="false">
      <el-form ref="form" :model="form" :rules="rules" label-width="120px">
        ...
        <el-form-item label="销售订单id" prop="salesId">
          <el-input v-model="form.salesId" placeholder="请输入销售订单id" />
        </el-form-item>
