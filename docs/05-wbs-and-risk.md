...
> **状态**：v1.2(追加 P3.7/P3.8/P4.1.8/P6.0 工作包,同步 `docs/08`/`docs/10` 发现)
...
| P3.7.3 MinIO 样品图/色卡存储(对接 02 AR-005)| P3.7.3 | **2** | - | 后端 | `MinioConfig` + `FileUploadUtils` 双实现 |
...
- 人日：63 + **9**(P3.7 8 + P3.8 1,不含条件触发 P3.8.3)= **72 人日**
- 日历周：8 周（人日并行）
