...
- **Prioritize by impact**: Always fix critical issues (waterfalls, bundle size) before optimizing lower-impact areas
- **Measure first**: Profile before optimizing - don't guess what's slow
- **Incremental improvement**: Apply one optimization at a time and measure impact
- **Follow existing patterns**: When working in existing codebases, respect established patterns
