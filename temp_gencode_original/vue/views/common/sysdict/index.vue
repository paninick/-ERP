<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['common:sysdict:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['common:sysdict:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['common:sysdict:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="sysdictList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="字典键值" align="center" prop="name" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="60%" append-to-body :close-on-click-modal="false" :close-on-press-escape="false">
      <el-form ref="form" :model="form" :rules="rules" label-width="120px">
        ...
        <el-form-item label="祖级列表" prop="parentIds">
          <el-input v-model="form.parentIds" type="textarea" placeholder="请输入内容" />
        </el-form-item>
        <el-form-item label="字典键值" prop="name">
          <el-input v-model="form.name" placeholder="请输入字典键值" />
        </el-form-item>
...
<script>
import { listSysdict, getSysdict, delSysdict, addSysdict, updateSysdict } from "@/api/common/sysdict"
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除字典数据编号为"' + ids + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('common/sysdict/export', {
        ...this.queryParams
      }, `sysdict_${new Date().getTime()}.xlsx`)
    }
  }
}
</script>
