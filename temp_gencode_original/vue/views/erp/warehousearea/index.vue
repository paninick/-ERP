...
<script>
import { listWarehousearea, getWarehousearea, delWarehousearea, addWarehousearea, updateWarehousearea } from "@/api/erp/warehousearea"
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('erp/warehousearea/export', {
        ...this.queryParams
