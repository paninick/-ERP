  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="100px">
      ...
      <el-form-item label="紧急程度" prop="emergencyType">
        <el-select v-model="queryParams.emergencyType" placeholder="请选择紧急程度" clearable>
          <el-option
            v-for="dict in dict.type.erp_sample_emergency"
            :key="dict.value"
            :label="dict.label"
            :value="dict.value"
          />
    ...
    <el-table v-loading="loading" :data="noticeList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="样品种类" align="center" prop="sampleCategoryType">
        <template slot-scope="scope">
      ...
      <el-table-column label="紧急程度" align="center" prop="emergencyType">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.erp_sample_emergency" :value="scope.row.emergencyType"/>
        </template>
      </el-table-column>
    ...
    <el-dialog :title="title" :visible.sync="open" width="60%" append-to-body :close-on-click-modal="false" :close-on-press-escape="false">
      <el-form ref="form" :model="form" :rules="rules" label-width="120px">
        ...
        <el-form-item label="紧急程度" prop="emergencyType">
          <el-select v-model="form.emergencyType" placeholder="请选择紧急程度">
            <el-option
              v-for="dict in dict.type.erp_sample_emergency"
              :key="dict.value"
              :label="dict.label"
        ...
        <el-form-item label="款式图片" prop="pictureUrl">
        ...
        <el-form-item label="审批人id" prop="auditBy">
          <el-input v-model="form.auditBy" placeholder="请输入审批人id" />
        </el-form-item>
