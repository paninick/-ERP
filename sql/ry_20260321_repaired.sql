...
create table sys_dept (
  dept_id           bigint(20)      not null auto_increment    comment'',
  ...
  status            char(1)         default ''0''                comment''0''                comment'''                 comment''',
...
create table sys_user (
  ...
  user_type         varchar(2)      default ''00''               comment'''                 comment'',
  phonenumber       varchar(11)     default''                 comment'',
  sex               char(1)         default ''0''                comment'''                 comment'',
  password          varchar(100)    default''                 comment'',
  status            char(1)         default ''0''                comment''0''                comment'''                 comment'',
  login_date        datetime                                   comment''''                 comment''',
  update_by         varchar(64)     default''                 comment''',
...
(
  ...
  status        char(1)         not null                   comment'''                 comment''',
  update_by     varchar(64)     default''          comment''',
  remark        varchar(500)    default null               comment'',
  primary key (post_id)
...
create table sys_role (
  ...
  data_scope           char(1)         default ''1''                comment'',
  menu_check_strictly  tinyint(1)      default 1                  comment''''0''                comment'''                 comment''',
  update_by            varchar(64)     default''                 comment''',
  remark               varchar(500)    default null               comment'',
  primary key (role_id)
) engine=innodb auto_increment=100 comment = ''?;
...
create table sys_menu (
  menu_id           bigint(20)      not null auto_increment    comment'',
  ...
  is_frame          int(1)          default 1                  comment'',
  is_cache          int(1)          default 0                  comment'',
  menu_type         char(1)         default''                 comment''''',
...
insert into sys_menu values(''118'',  ''?, ''3'',   ''4'', ''automation'', ''erp/automation/index'','','', 1, 0, ''C'', ''0'', ''0'', ''erp:automation:list'',     ''automatic'',     ''admin'', sysdate(),'', null, ''?);
-- 
...
-- ?
insert into sys_menu values(''1061'','', ''118'', ''1'', ''#'','','','', 1, 0, ''F'', ''0'', ''0'', ''erp:automation:query'',       ''#'', ''admin'', sysdate(),'', null,'');
insert into sys_menu values(''1062'','', ''118'', ''2'', ''#'','','','', 1, 0, ''F'', ''0'', ''0'', ''erp:automation:add'',         ''#'', ''admin'', sysdate(),'', null,'');
insert into sys_menu values(''1063'','', ''118'', ''3'', ''#'','','','', 1, 0, ''F'', ''0'', ''0'', ''erp:automation:edit'',        ''#'', ''admin'', sysdate(),'', null,'');
insert into sys_menu values(''1064'','', ''118'', ''4'', ''#'','','','', 1, 0, ''F'', ''0'', ''0'', ''erp:automation:remove'',      ''#'', ''admin'', sysdate(),'', null,'');
insert into sys_menu values(''1065'','', ''118'', ''5'', ''#'','','','', 1, 0, ''F'', ''0'', ''0'', ''erp:automation:run'',         ''#'', ''admin'', sysdate(),'', null,'');
insert into sys_menu values(''1066'','', ''118'', ''6'', ''#'','','','', 1, 0, ''F'', ''0'', ''0'', ''erp:automation:pause'',       ''#'', ''admin'', sysdate(),'', null,'');
insert into sys_menu values(''1067'','', ''118'', ''7'', ''#'','','','', 1, 0, ''F'', ''0'', ''0'', ''erp:automation:export'',      ''#'', ''admin'', sysdate(),'', null,'');
...
create table sys_role_menu (
  role_id   bigint(20) not null comment'',
  menu_id   bigint(20) not null comment'',
...
create table sys_oper_log (
  ...
  business_type     int(2)          default 0                  comment'''                 comment'',
  request_method    varchar(10)     default''                 comment'',
  operator_type     int(1)          default 0                  comment'',
  oper_name         varchar(50)     default''                 comment'',
  dept_name         varchar(50)     default''                 comment'',
  oper_url          varchar(255)    default''                 comment'',
  ...
  status            int(1)          default 0                  comment'''                 comment'',
...
(
  ...
  status           char(1)         default ''0''                comment'''                 comment''',
  update_by        varchar(64)     default''                 comment''',
  remark           varchar(500)    default null               comment'',
  primary key (dict_id),
  unique (dict_type)
...
(
  ...
  dict_value       varchar(100)    default''                 comment'''                 comment'',
  css_class        varchar(100)    default null               comment''',
  is_default       char(1)         default ''N''                comment'',
  status           char(1)         default ''0''                comment'''                 comment''',
  update_by        varchar(64)     default''                 comment''',
  remark           varchar(500)    default null               comment'',
...
create table sys_config (
  ...
  config_value      varchar(500)    default''                 comment''N''                comment'',
  create_by         varchar(64)     default''                 comment''',
  update_by         varchar(64)     default''                 comment''',
  remark            varchar(500)    default null               comment'',
...
insert into sys_config values(3, ''-?,           ''sys.index.sideTheme'',              ''theme-dark'',    ''Y'', ''admin'', sysdate(),'', null, ''theme-darkheme-light'' );
insert into sys_config values(4, ''-?,           ''sys.account.captchaEnabled'',       ''true'',          ''Y'', ''admin'', sysdate(),'', null, ''ruefalse?);
insert into sys_config values(5, ''-?, ''sys.account.registerUser'',         ''false'',         ''Y'', ''admin'', sysdate(),'', null, ''truefalse?);
...
insert into sys_config values(8, ''-'',     ''sys.account.passwordValidateDays'', ''0'',             ''Y'', ''admin'', sysdate(),'', null, ''00365'');
...
create table sys_logininfor (
  info_id        bigint(20)     not null auto_increment   comment'',
  user_name      varchar(50)    default''                comment'',
  ipaddr         varchar(128)   default''                comment'',
  login_location varchar(255)   default''                comment'',
  browser        varchar(50)    default''                comment'''                comment'',
  status         char(1)        default ''0''               comment'''                comment'',
...
create table sys_job (
  job_id              bigint(20)    not null auto_increment    comment'',
  job_name            varchar(64)   default''                 comment'',
  job_group           varchar(64)   default ''DEFAULT''          comment'',
  invoke_target       varchar(500)  not null                   comment'''                 comment''3''                comment''1''                comment''0''                comment'''                 comment''',
  update_by           varchar(64)   default''                 comment''',
  remark              varchar(500)  default''                 comment'',
...
create table sys_job_log (
  job_log_id          bigint(20)     not null auto_increment    comment'',
...
create table sys_notice (
  notice_id         int(4)          not null auto_increment    comment'',
  notice_title      varchar(50)     not null                   comment'',
  notice_type       char(1)         not null                   comment''',
  status            char(1)         default ''0''                comment'''                 comment''',
  update_by         varchar(64)     default''                 comment''',
...
create table sys_notice_read (
  ...
  notice_id        int(4)           not null                   comment'',
  user_id          bigint(20)       not null                   comment'',
...
create table gen_table (
  ...
  table_name        varchar(200)    default''                 comment'''                 comment'''',
  class_name        varchar(100)    default''                 comment''crud''             comment'''                 comment''''''''0''                comment'',
...
create table gen_table_column (
  ...
  java_field        varchar(200)                               comment''',
  is_increment      char(1)                                    comment'',
  is_required       char(1)                                    comment'',
  is_insert         char(1)                                    comment'',
