...
insert into sys_config values(3, '    -     ',           'sys.index.sideTheme',              'theme-dark',    'Y', 'admin', sysdate(), '', null, '    theme-dark     theme-light' );
insert into sys_config values(4, '    -     ',           'sys.account.captchaEnabled',       'true',          'Y', 'admin', sysdate(), '', null, '          true   false   ');
...
insert into sys_config values(7, '    -        ',     'sys.account.initPasswordModify',   '1',             'Y', 'admin', sysdate(), '', null, '0                   1                                ');
...
create table gen_table (
  ...
  tpl_web_type      varchar(30)     default ''                 comment '       element-ui   element-plus   ',
...
create table gen_table_column (
  ...
  is_pk             char(1)                                    comment '     1  ',
  is_increment      char(1)                                    comment '     1  ',
  is_required       char(1)                                    comment '     1  ',
  is_insert         char(1)                                    comment '        1  ',
  is_edit           char(1)                                    comment '       1  ',
  is_list           char(1)                                    comment '       1  ',
  is_query          char(1)                                    comment '       1  ',
