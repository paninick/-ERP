...
insert into sys_config values(3, '-',           'sys.index.sideTheme',              'theme-dark',    'Y', 'admin', sysdate(), '', null, 'theme-darktheme-light' );
insert into sys_config values(4, '-',           'sys.account.captchaEnabled',       'true',          'Y', 'admin', sysdate(), '', null, 'truefalse');
...
insert into sys_config values(7, '-',     'sys.account.initPasswordModify',   '1',             'Y', 'admin', sysdate(), '', null, '01');
